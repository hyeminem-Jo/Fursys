...
(function (b) {
	var a = function (j, q) {
		...
		/*if (g.stopOnClick) {
			...
			b(".nivo-slice").click(function () {
				...
				if(m.stop){
					...
					$(".nivoSlider").css("background", "url(" + m.currentImage.attr("src") + ") no-repeat");
					$(".nivo-slice").css("background", "url(" + m.currentImage.attr("src") + ") no-repeat");
					$(".nivo-controlNav a").removeClass("active");
					$(".nivo-controlNav a:eq(" + m.currentSlide + ")").addClass("active");
		...
		var p = function (r, s, u, x) {
			...
			if (u.effect == "sliceDown" || u.effect == "sliceDownRight" || y.randAnim == "sliceDownRight" || u.effect == "sliceDownLeft" || y.randAnim == "sliceDownLeft") {
				...
				C.each(function () {
			...
			} else { if (u.effect == "sliceUp" || u.effect == "sliceUpRight" || y.randAnim == "sliceUpRight" || u.effect == "sliceUpLeft" || y.randAnim == "sliceUpLeft") {
					var t = 0;
					var w = 0;
					var C = b(".nivo-slice", r);
					...
					C.each(function () {
				...
				} else { if (u.effect == "sliceUpDown" || u.effect == "sliceUpDownRight" || y.randAnim == "sliceUpDown" || u.effect == "sliceUpDownLeft" || y.randAnim == "sliceUpDownLeft") {
						var t = 0;
						var w = 0;
						var B = 0;
						var C = b(".nivo-slice", r);
					...
					} else { if (u.effect == "fold" || y.randAnim == "fold") {
							var t = 0;
							var w = 0;
							b(".nivo-slice", r).each(function () {
								var i = b(this);
						...
						} else { if (u.effect == "fade" || y.randAnim == "fade") {
								var w = 0;
								b(".nivo-slice", r).each(function () {
